...
function Post() {
  ...
  return (
    <div className="post">
      <img className="postImg" src={randomImage} alt="Travel destination" />
      ...
      <p className="postDesc">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga itaque alias architecto,
        libero facere placeat voluptates! Cum minima sint incidunt id nisi, modi enim ducimus illo
        sapiente. Labore, doloribus eius.
      </p>
    </div>
  );
}
